...
func init() {
	histogramSignature := flux.MustLookupBuiltinType("universe", "histogram")
...
var linearBinsType = flux.MustLookupBuiltinType("universe", "linearBins")
...
var logarithmicBinsType = flux.MustLookupBuiltinType("universe", "logarithmicBins")
