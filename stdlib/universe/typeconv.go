...
func (f *stringConv) Stream() values.Stream {
...
func (f *intConv) Stream() values.Stream {
	panic(values.UnexpectedKind(semantic.Object, semantic.Stream))
}
...
func (f *uintConv) Stream() values.Stream {
	panic(values.UnexpectedKind(semantic.Object, semantic.Stream))
}
...
func (f *floatConv) Stream() values.Stream {
	panic(values.UnexpectedKind(semantic.Object, semantic.Stream))
}
...
func (f *timeConv) Stream() values.Stream {
	panic(values.UnexpectedKind(semantic.Object, semantic.Stream))
}
...
func (f *durationConv) Stream() values.Stream {
	panic(values.UnexpectedKind(semantic.Object, semantic.Stream))
}
