...
func init() {
	...
	SpecialFns = map[string]values.Function{
		"compile": values.NewFunction(
			"compile",
			flux.MustLookupBuiltinType("regexp", "compile"),
		...
		"quoteMeta": values.NewFunction(
			"quoteMeta",
			flux.MustLookupBuiltinType("regexp", "quoteMeta"),
			func(ctx context.Context, args values.Object) (values.Value, error) {
				v, ok := args.Get("v")
				if !ok {
					return nil, errors.New(codes.Invalid, "missing argument v")
		...
		"findString": values.NewFunction(
			"findString",
			flux.MustLookupBuiltinType("regexp", "findString"),
			func(ctx context.Context, args values.Object) (values.Value, error) {
				v, ok := args.Get("v")
				r, okk := args.Get("r")
				if !ok || !okk {
		...
		"findStringIndex": values.NewFunction(
			"findStringIndex",
			flux.MustLookupBuiltinType("regexp", "findStringIndex"),
			func(ctx context.Context, args values.Object) (values.Value, error) {
				v, ok := args.Get("v")
				r, okk := args.Get("r")
				if !ok || !okk {
		...
		"matchRegexpString": values.NewFunction(
			"matchRegexpString",
			flux.MustLookupBuiltinType("regexp", "matchRegexpString"),
			func(ctx context.Context, args values.Object) (values.Value, error) {
				v, ok := args.Get("v")
				r, okk := args.Get("r")
				if !ok || !okk {
		...
		"replaceAllString": values.NewFunction(
			"replaceAllString",
			flux.MustLookupBuiltinType("regexp", "replaceAllString"),
			func(ctx context.Context, args values.Object) (values.Value, error) {
				r, ok := args.Get("r")
				v, okk := args.Get("v")
				t, okkk := args.Get("t")
		...
		"splitRegexp": values.NewFunction(
			"splitRegexp",
			flux.MustLookupBuiltinType("regexp", "splitRegexp"),
			func(ctx context.Context, args values.Object) (values.Value, error) {
				r, ok := args.Get("r")
				v, okk := args.Get("v")
				i, okkk := args.Get("i")
		...
		"getString": values.NewFunction(
			"getString",
			flux.MustLookupBuiltinType("regexp", "getString"),
			func(ctx context.Context, args values.Object) (values.Value, error) {
				r, ok := args.Get("r")
				if !ok {
					return nil, errors.New(codes.Invalid, "missing argument")
